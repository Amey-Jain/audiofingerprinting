...
#gcc -c -g spectogram.c spectogram.h config.h permutations.h -I$HOME/ffmpeg_build/include -I$HOME/ffmpeg_build/include/libavutil -L$HOME/ffmpeg_build/lib -lavutil -lfftw3 -lm ;
gcc -c -g test.c -I$HOME/ffmpeg_build/include; 
gcc -c -g permutations.c;
